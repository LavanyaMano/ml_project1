...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Catagerical columns encoding completed")
            ...
            preprocessor = ColumnTransformer(
                [
                    ...
                    ("catagorical_pipeline", cat_pipeline, catagorical_columns)
                ]
            )
            return preprocessor
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("Applying preprocessing on my training and test dataframes")
            ...
            logging.info(f"Saving preprocessed file. ")
